...
class MyCVSeeder extends Seeder
{
    ...
    public $positions = [
        ...
        [
            ...
            'location'      => 'Cape Town, South Africa',
            'description'   => 'Co-founded Clickthinking with partner Peter Stewart and as IT Director I was responsible for all technical aspects of the business from internal infrastructure and the managemment of our US and UK dedicated full stack hosting to systems design and build management of bespoke CMS\'s.',
        ...
        [
            ...
            'location'      => 'Cape Town, South Africa',
            'description'   => 'While contracting for &Beyond I was involved in the design and build of various CMS\'s from bespoke 1st generation booking engines with ecommerce integration in the late 1990\'s to the first build of Go2Africa.com, which at that time, was a dynamic ASP engine that built this 10 000 page tourism authority hub.',
            'thumb'         => 'andbeyond.png',
            'current'       => 0,
